 ...
 **************************************************************************/
package com.vtc.connection.common.constant;
...
public class Constant {
    ...
    public static final String LUCKYSPIN_BUY_TURN_XU                 = "XU";
    ...
    public static final int    ACTION_SHARE_LINK_FACEBOOK            = 6;
    public static final int    MISSION_SATISFYING_DEFAULT            = 1;
    public static final int    MISSION_PROGRESS_DEFAULT              = 1;
    public static final String MISSION_AWARD_XU                      = "XU";
    public static final String MISSION_AWARD_TURN_SPIN               = "TURN_SPIN";
    public static final String MISSION_AWARD_GIFTCODE                = "GIFTCODE";
    ...
    public static final String GIFTCODE_EVENT_TYPE_MISSION           = "MISSION";
...
//    public static final String SCOIN_CARD_PARTNER_CODE               = "ttvasminigame"; // Account Real
    ...
    public static final String SCOIN_PAYMENT_TYPE_CARD_SCOIN     = "CARD_SCOIN";
    public static final String SCOIN_PAYMENT_TYPE_WALLET_TO_GAME = "SCOIN";
    public static final String SCOIN_PAYMENT_TYPE_CARD_SCOIN_CROSS= "CARD";
    public static final String SCOIN_PAYMENT_TYPE_CARD_TO_GAME   = "CARD";
    public static final String SCOIN_PAYMENT_SANDBOX_PAYMENT_HISTORY_APIKEY= "scoin_payment_sandbox_history"; //a8f7050ba6d7076d39c26891b6017e52
    public static final String SCOIN_PAYMENT_LIVE_PAYMENT_HISTORY_SECURE_SECRET = "EFS4svggk9jHtqeIGAq";
