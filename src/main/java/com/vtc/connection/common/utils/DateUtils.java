package com.vtc.connection.common.utils;
...
public class DateUtils {
  ...
  //convert from DATE to DATE and change FORMAT
    ...
    public static List<String> toStringDaysBetweenTwoDay(Date start, Date end, String fomatDate) {
        
        try {
            List<String> daysOfBetweenDate = new ArrayList<String>();
